...
class DiffusionHead(nn.Module):
  ...
  def __init__(
      ...
      diffuser_rotational_alignment=True,
    ...
    self.diffuser_rotational_alignment = diffuser_rotational_alignment
  ...
  def loss(self, value, batch):
    ...
    with accelerator.autocast(enabled=False):
      ...
      if self.diffuser_rotational_alignment:
        # weighted_align
        with torch.no_grad():
