...
def residue_atom_array(
  ...
  pad_length = residue_constants.atom14_type_num - atom_array.array_length()
  if pad_with_virtual_atoms and pad_length > 0:
    pad_atoms = atom_array[np.isin(atom_array.atom_name, ['CA', 'P'])]
    ...
    atom_array = structure.concatenate([atom_array, pad_atoms])
